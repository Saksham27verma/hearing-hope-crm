...
/**
 * Vercel Cron (every 5 minutes): remind assigned staff when an appointment start time is reached.
 * Secured with CRON_SECRET (Vercel sets Authorization: Bearer <CRON_SECRET> when the env var exists).
 */
